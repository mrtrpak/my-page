  ...
  return (
    <Paper elevation={3}>
      <Grid container alignItems="center" justify="space-around" spacing={3}>
        ...
        <Grid container item alignItems="center" justify="center" spacing={1} xs={12} md={10} style={{ marginLeft: "3px" }}>
          <Grid item xs={7} md={8}>
        ...
        <Grid container item justify="center" spacing={1} xs={12} md={2} className="infoSection">
